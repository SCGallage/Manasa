...
//        echo dirname(__DIR__, 2).$_ENV['PROFILE_LOCATION'];
    ...
    public function findAllSupportGroupsWithRequestsByUserId($userId): array|bool|int
    {
    ...
    public function findAllSupportGroups(): array|bool|int
    {
        $sqlStatement = "SELECT * FROM supportgroup";
        return $this->customSqlQuery($sqlStatement, DatabaseService::FETCH_ALL);
    }

    public function getSupportGroupById($sgId): array|bool|int
    {
     ...
     *
     * */
    public function participateSgEvent($userId, $eventId): bool|int
    {
