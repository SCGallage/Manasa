                ...
                <table>
                    ...
                    foreach ($viewSGRequest as $row) { ?>
                        <tr>
                            ...
                            <td> <a href="/admin/SGRequestsUpdate?id=<?php echo $row['id'] ?>&capacity=<?php echo $row['capacity'] ?>&type=<?php echo $row['type']?>&name=<?php echo $row['name'] ?>" class="button1">Accept</a></td>
