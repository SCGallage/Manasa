    ...
    <div class="row flex-container">
        ...
        <div class="col-l-6 col-m-12 col-s-12 flex-gap1 primary-card card-content">
            <div class="col-l-12 col-m-12 col-s-12 padding1">
                <span class="head-text">Befriender Report</span>
            </div>

            <div class="col-l-12 col-m-12 col-s-12 card2">
                <form action="/admin/befrienderReport" class="form1" method="post" name="reportGenForm" onsubmit="return reportGenValidation()">

                    <div class="col-l-12 col-m-12 col-s-12 ">
                        <p class="text-style3">
                            Befriender Report provides an overview of the selected volunteers activities during the given time duration.
                            This depicts details of the befriender, sessions he/she have conducted and work shifts during the time period.
                        </p>
                    </div>
                    <div class
                         ="col-l-12 col-m-12 col-s-12 padding-top">
                        <label for="name" class="text-style3">Befriender Name:</label>
                    </div>
                    <div class="col-l-12 col-m-12 col-s-12 ">
...
<!--Add select two function to the specified select class in the form-->
<!--<script>-->
