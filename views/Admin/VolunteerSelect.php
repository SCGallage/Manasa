            ...
            <div class="col-l-12 col-m-12 col-s-12">
                ...
                <div class="col-l-12 col-m-12 col-s-12 scroll2">
                    ...
                    <div class="upper-box-details card1 margin-top">
                        <div class="col-l-12 col-m-12 col-s-12">
                            <span class="select-text"><a href="/admin/viewVolunteerInformation?id=<?php echo $selectedParticipants['volunteerId'] ?>"><?php echo $selectedParticipants['fname']." ".$selectedParticipants['lname'];?></a></span><br>
                            <td> <a href="/admin/rejectVolunteer?id=<?php echo $selectedParticipants['volunteerId'] ?>" class="cancel-button-1">Reject</a></td>
                        </div>
                    </div>
                    <?php }?>
                </div>
            ...
            <div class="col-l-12 col-m-12 col-s-12 scroll2 margin-top">
                ...
                <table class="custom-table">
                    ...
                    foreach ($participantRequests as $req) {
                        ?>
                        <tr>
                            <td><a href="/admin/viewVolunteerInformation?id=<?php echo $req['volunteerId'] ?>"><?php echo $req['fname']." ".$req['lname']?></a></td>

                            <!--                                    Hide accept button if participant capacity is filled -->
                            <?php  if ($participantsCount == $data['capacity'] ){ ?>
                            <td> <a href="/admin/rejectVolunteer?id=<?php echo $req['volunteerId'] ?>" class="cancel-button">Reject</a></td>
                            <?php }else{ ?>
                            <td>
                                <form method="post" action="/admin/acceptVolunteer">
