...
<main>
    ...
    <div class="row flex-container ">
        <div class="col-l-12 col-m-12 col-s-12 flex-gap">
            <a href="/admin/viewVolunteerEvent"><span class="head-text2">Volunteer Events</span></a>
        </div>
    </div>
        ...
        <div class="col-l-12 col-m-12 col-s-12 flex-gap1 primary-card card-content">
            <div class="col-l-12 col-m-12 col-s-12 padding1">
                ...
                <div class="col-l-6 col-m-12 col-s-12">
                    <button class="add-text"><a href="/admin/createVolunteerEvent">+Add Event</a></button>
                </div>
            </div>

            <?php if ($eventDetails == null){?>
                <div class="col-l-12 col-m-12 col-s-12 card-content">
                    <span class="head-text5">No Upcoming Events Available</span>
                </div>
            <?php }else{
                ...
                <div class="event-card">
                    <div class="col-l-12 col-m-12 col-s-12 flex-container3">
                        ...
                        <div class="col-l-4 col-m-8 col-s-8">
                            <div class="col-l-12 col-m-12 col-s-12">
                                    ...
                                    <div class="modal-content modal-container">
                                        ...
                                        <div class="clearfix padding-top">
                                            ...
                                            <a onclick="document.getElementById('deleteEvent<?php echo $data['id'] ?>').style.display='none'"
                                               ...
                                               href="/admin/deleteVolunteerEvent?id=<?php echo $data['id'] ?>" >Delete</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a href="/admin/updateVolunteerEvent?id=<?php echo $data['id'] ?>">
                    ...
                    <div class="col-l-12 col-m-12 col-s-12 flex-container padding-top-1">
                        ...
                        <div class="col-l-3 col-m-12 col-s-12">
                            ...
                            <div class="col-l-10 col-m-10 col-s-10 "><span class="custom-text"><?php echo date('H:i', strtotime($data['startTime'] ))." - " .date('H:i', strtotime($data['endTime'] ));?></span></div>
                        </div>
                    ...
                    <div class="col-l-12 col-m-12 col-s-12 padding1">
                        <a href="/admin/selectVolunteer?id=<?php echo $data['id'] ?>">
                            <span class="button7">
...
<script>
    var modal = document.getElementById('deleteEvent');
