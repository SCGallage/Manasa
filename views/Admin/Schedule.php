...
<main>
    ...
    <div class="row flex-gap">
        <div class="col-l-12">
            ...
            <div class="col-l-6">
<!--                <span class="add-text padding-top"><a href="/admin/CreateSchedule"> +Add Schedule</a></span>-->
                <span class="add-text padding-top"><a href="/admin/upcomingSchedule"> Upcoming Schedule  </a></span>
            </div>
        </div>
    </div>
        ...
        <div class="col-l-12 col-m-12 col-s-12 upper-box card-content ">
            <div class="col-l-12 col-m-12 col-s-12 ">
                ...
                <div class="col-l-1 col-m-12 col-s-12 padding-top">
                    ...
                    <form method="post" action="/admin/unlockSchedule" name="unlockForm" id="unlockForm">
                    <label class="switch">
                    ...
                    <?php }else{?>
                    <form method="post" action="/admin/lockSchedule">
                        <label class="switch">
                            <input type="submit">
                            <input type="hidden" class="button1" value="<?php echo $scheduleData['scheduleId']?>" name="scheduleId">
                            <span class="slider"></span>
...
<!--                        Display Dates from 1-7 -->
                    ...
                    <?php foreach ($morningShifts1 as $data) { ?>
                        <div class="grid-item-slot">
                            ...
                            <button class="view-btn"><a href="/admin/ScheduleSelect?id=<?php echo $data['shiftId']?>&scheduleId=<?php echo $scheduleData['scheduleId']?>">VIEW</a></button>
                        </div>
                    <?php }?>
                        <div class="grid-item-time">
...
<!--                        Display Dates from 7-14-->
            ...
            <div class="col-l-12 col-m-12 col-s-12 padding1">
                <span class="button1">
                    <a href="/admin/FixSchedule?scheduleId=<?php echo $scheduleData['scheduleId']?>">
                        Set Schedule
                    </a>
                </span>
            </div>
