<?php
    ...
    if (array_key_exists('meetingType', $params) && array_key_exists('searchedDate', $params)){
        $dateSearched = $params['searchedDate'];
...
?>
<div class="col-l-12 col-m-12 col-s-12 bg-color-4" xmlns="http://www.w3.org/1999/html">
...
?>
        ...
        <form action="/loadJoinRequestTimeSlots"
              method="post"
            ...
            <input type="date"
                   ...
                   value="<?php if (strcmp($dateSearched, 'not_set')) echo $dateSearched?>">
            <div class="col-s-0 col-m-2 col-l-3 text-hidden">.</div>
...
?>
            <div class="col-s-12 col-m-12 col-l-12 normal-card shadow-2 bg-color-3 list-card">
                ...
                <div class="col-s-12 col-m-12 col-l-2">
                    <div class="col-s-12 col-m-12 col-l-12">
                        <form action="/completeSgJoinRequest" method="post">
