...
<div id="popup" class="col-s-7 col-m-8 col-l-6 popup-card list-card shadow-2 border-color-1 bg-color-4">
    <h2 id="warning_title" class="col-s-12 col-m-12 col-l-12 text-center heading color-6">

    </h2>
    <h4 id="warning_subtitle" class="col-s-12 col-m-12 col-l-12 text-center heading color-1"></h4>
    <h4 id="warning_message" class="col-s-12 col-m-12 col-l-12 text-center heading color-1"></h4>
