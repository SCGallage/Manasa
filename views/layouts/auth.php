...
<nav class="navbar">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a href="/befriender/dashboard?befid=<?php echo $_SESSION['user_id'] ?>" class="nav-link">
...
<!--        <li class="nav-item">-->
<!--            <a href="/befriender/supportgroup" class="nav-link">-->
...
<!--        </li>-->
        ...
        <li class="nav-item">
            <a href="/befriender/schedule" class="nav-link">
