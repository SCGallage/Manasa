    ...
    <div class="col-s-12 col-m-12 col-l-12 list-card normal-card shadow-2 bg-color-7">
        <div class="normal-card">
            <div class="col-l-12 col-m-12 col-s-12">
                <div class="col-l-8 col-m-8 col-s-8 heading color-1"> <span >Annual Workshop</span></div>
            ...
            <input class="col-s-12 col-m-3 col-l-2 color-4 bg-color-6 normal-card border-color-tranparent bannerButton" type="button" value="Cancel Participation">
        </div>
    </div>
    <div class="col-s-12 col-m-12 col-l-12 list-card normal-card shadow-2 bg-color-7">
        <div class="normal-card">
