            ...
            <div class="col-l-7">
                ...
                <div class="col-l-12 col-m-12 col-s-12 flex-gap1">
                    <div class="primary-card card-content">
                        <form name="createEventForm" action="/mod/updateVolunteerEvent" class="form1" method="post"  onsubmit="return createVolEventForm()">
                            ...
                            <div class="col-l-12 col-m-12 col-s-12 flex-container padding-top">
                                <div class="col-l-6 col-m-12 col-s-12 padding-right flex-container2">
                                    ...
                                    <div class="col-l-12 col-m-12 col-s-12">
                                        <input type="time" name="startTime" value="<?php echo $data['startTime'] ?>" required>
                                        <span class="required-text">*Required</span>
                                    </div>
                                </div>
                                <div class="col-l-6 col-m-12 col-s-12 padding-left flex-container2">
                                    ...
                                    <div class="col-l-12 col-m-12 col-s-12">
                                        <input type="time" name="endTime" value="<?php echo $data['endTime'] ?>" required>
                                        <span class="required-text">*Required</span>
                                    </div>
                                </div>
                            </div>
