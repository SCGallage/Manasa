            ...
            <div class="col-l-7">
                ...
                <div class="col-l-12 col-m-12 col-s-12 flex-gap1">
                    <div class="primary-card card-content">
                        <form name="createEventForm" action="/mod/createVolunteerEvent" class="form1" method="post"  onsubmit="return createVolEventForm()">
                            ...
                            <div class="col-l-12 col-m-12 col-s-12 padding-top">
                                ...
                                <div class="col-l-12 col-m-12 col-s-12 ">
                                    <select name="moderator" class="select2 custom-font" required>
                                        <option value="0" class="custom-font" selected disabled>Please select Moderator</option>
                                        <?php
